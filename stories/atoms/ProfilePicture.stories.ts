...
import ProfilePicture from "../../components/atoms/Avator.vue";

const meta: Meta<typeof ProfilePicture> = {
  title: "Atomic/ProfilePicture",
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "The `ProfilePicture` component displays a user's avatar image with a status indicator. " +
          "It supports online and offline statuses and customizable image sources.",
      },
    },
  },
  tags: ["autodocs"],
  argTypes: {
    source: {
      control: { type: "text" },
      description: "The URL of the profile picture. Supports external image links.",
      table: {
        type: { summary: "string" },
    ...
    status: {
      ...
      description: "The user's current status, displayed as a badge.",
      table: {
        type: { summary: "string" },
...
export const Default: Story = {
  args: {
    source: "https://via.placeholder.com/150", // Default placeholder image
    status: "online",
  },
  parameters: {
    docs: {
      description: {
        story:
          "This is the default state of the `ProfilePicture` component, showing an online status " +
...
export const Offline: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "The `ProfilePicture` component in its offline state. Notice the gray status indicator.",
      },
    },
  },
};
...
export const CustomImage: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "The `ProfilePicture` component with a custom image source and an online status indicator.",
      },
    },
  },
};
